...
execute as @e[type=villager,nbt={VillagerData:{level:1}},nbt={ArmorItems:[{id:"minecraft:diamond_chestplate",tag:{display:{Name:'{"text":"Wanderer\'s Spirit"}'}}}]}] at @s run function beyond_armor:convert_trader
